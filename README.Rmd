...
- `%:%`: binds columns together horizontally. It allows us to include both character and numeric vectors in the same row.
...
- `output_path`: Directory path in which to place the PDF. Default is `getwd()`, i.e., the current directory.
